...
$sql1 = "SELECT Singer.name,Album.title, Album.releasedDate, Album.genre ,Album.rating
...
<head>
  ...
  <body>
    <font color="green"><h2> >>> Sort all the albums of a singer by a title of album (A to Z) </h2></font>
