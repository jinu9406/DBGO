...
$sql1 = "DELETE FROM AddMusicMA WHERE myAlbum_id = 7 AND music_id = 1";
$sql2 = "SELECT * from AddMusicMA NATURAL JOIN Music where myAlbum_id = 7";
$sql3 = "INSERT INTO AddMusicMA(myAlbum_id, music_id) VALUES(7, 1)";
...
<head>
  ...
  <body>
    <font color="green"><h2> >>> Add new music in a user's MyAlbum </h2></font>
