...
$sql1 = "INSERT INTO MyAlbum (user_id, title, introduction, isPrivate) values(3, 'dance', 'dance dance', 0)";
$sql2 = "SELECT user_id, title, introduction FROM MyAlbum WHERE user_id = 3";
$sql3 = "DELETE FROM MyAlbum WHERE user_id = 3 AND title = 'dance'";
...
<head>
  ...
  <body>
    <font color="green"><h2> >>> Delete one MyAlbum </h2></font>
    ...
    <p>
      ...
      <h4>
        DELETE FROM MyAlbum WHERE user_id = 3 AND title = 'dance';
      </h4>
    </p>
