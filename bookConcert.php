...
$sql1 = "DELETE FROM BookConcert WHERE user_id = 3 AND concert_id = 3";
...
$sql4 = "INSERT INTO BookConcert(user_id, concert_id) VALUES(3, 3)";
...
<head>
  ...
  <body>
    <font color="green"><h2> >>> Make a reservation of concert successfully </h2></font>
