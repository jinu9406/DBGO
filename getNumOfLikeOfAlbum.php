...
$sql2 = "CREATE VIEW LikeAlbum AS SELECT * FROM LikeMedia WHERE mediaInfo_id = 2";
$sql3 = "SELECT A.title, count(B.media_id) as numOfLike
FROM Album A JOIN LikeAlbum B
ON A.album_id = B.media_id
WHERE B.media_id = 12";
...
<head>
  ...
  <body>
    <font color="green"><h2> >>> Get number of likes of one album by LikeMedia </h2></font>
