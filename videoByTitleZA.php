...
$conn = mysqli_connect(
  ...
  $sql1 = "SELECT Singer.name, Video.title
          ...
          WHERE Singer.singer_id=17 ORDER BY Video.title DESC";
...
while($row = mysqli_fetch_array($result1)) {
  $list1 = $list1."<li>SINGER: {$row['name']} &nbsp &nbsp TITLE: {$row['title']}<br><br></li>";
}
?>
...
<head>
  ...
  <body>
    <font color="green"><h2> >>> Sort all the videos of one singer by a title of video (Z to A) </h2></font>
